...
export class ${protoFile.funcName[0].toUpperCase() + protoFile.funcName.slice(1)}BlockchainCaller {
   ...
   */
  static async newDefault(${mode == 'web3' ? "envPath = './'" : 'providerName: string, accountIndex: number'}): Promise<${protoFile.funcName[0].toUpperCase() + protoFile.funcName.slice(1)}BlockchainCaller> {
